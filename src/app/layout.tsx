...
export const metadata: Metadata = {
  title: "TechForward - Leading IT Solutions & Digital Transformation",
  description: "Transform your business with cutting-edge IT solutions. AI/ML, cloud computing, cybersecurity, and custom software development services.",
  keywords: "IT solutions, digital transformation, AI machine learning, cloud computing, cybersecurity, software development",
